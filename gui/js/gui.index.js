  ...
  self.createModel = function (type, options) {
    ...
    switch(type) {
      ...
      case "gradientdescent":
        ...
        break;
      case "genetico":
        model = new Genetico(options);
        _main = mainCluster;
        break;
      default:
        throw new Error("Undefined model, try kmeans, dbscan, knn, "
          +"id3, gradientdescent, genetico");
    }
...
$(document).ready(function() {
  ...
  $formOptionsModel.submit(function(event) {
    ...
    if (model instanceof Genetico) {
      modelInfo.individuoMax = model.individuoMax;
      modelInfo.fitness = model.fitness;
    }
